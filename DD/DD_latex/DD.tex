...
The authentication and authorization will be implemented using a token-based process. These tokens are sent to the user each time they log in and must be included with each request that requires authentication or authorization.
